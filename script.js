...
var viewWidth = parseInt(getComputedStyle(container).width)
var viewHeight = parseInt(getComputedStyle(container).height)
...
window.addEventListener("resize", function(event) {
    ...
    viewHeight = parseInt(getComputedStyle(container).height)
});
